...
/**
 * @author zhangliyan by 2017-09-04-下午 3:41
 */
public class ReceiveDirectLogs {
    //定义一个exchangename
    public static final String QUEUE_NAME="direct_queue_logs";
    ...
    public static void main(String[] args) throws Exception {
        ...
        DefaultConsumer defaultConsumer=new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope,
                ...
                System.out.println("[x] Received error log: '"+message+"'");
            }
        };
        //消费
